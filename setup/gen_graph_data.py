...
def main():
    ...
    for dataset_name in ['synthetic_2_50_train1_pos','synthetic_2_50_train1_neg','synthetic_1_50_train1_pos','synthetic_1_50_train1_neg','synthetic_2_40_train1_pos','synthetic_2_33_train1_pos','synthetic_2_25_train1_pos','synthetic_2_40_train1_neg','synthetic_2_33_train1_neg','synthetic_2_25_train1_neg','synthetic_1_40_train1_pos','synthetic_1_33_train1_pos','synthetic_1_25_train1_pos','synthetic_1_40_train1_neg','synthetic_1_33_train1_neg','synthetic_1_25_train1_neg']:
        try:
            graphs = load_custom_graph_list(
                r'data/{}/{}/{}.p'.format(dataset_name[:dataset_name[:dataset_name.rindex('_', 0, dataset_name.rfind('_'))].rfind('_')]\
                , dataset_name[:dataset_name.rindex('_', 0, dataset_name.rfind('_'))]\
                , dataset_name),     #second to last character 
                min_num_nodes=30,
                max_num_nodes=30,
                name=f'{dataset_name}',
        ...
        except: raise NotImplementedError(f'Dataset {dataset_name} not supported.')
