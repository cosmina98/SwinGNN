...
def node_adj_go_training(model, optimizer, scheduler, ema_helper,
    ...
    for epoch in range(config.train.max_epoch):
        ...
        for sample_interval in  sample_intervals:
            if epoch / (sample_interval-1) == 1 and epoch != 0:
