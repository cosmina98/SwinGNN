...
def gen_mol(x, adj, dataset, largest_connected_comp=True):    
    ...
    if dataset == 'QM9':
        ...
        atomic_num_list=[1, 35, 6, 7, 8, 9, 15, 16, 17, 53,0]
         ...
         atomic_num_list=[1, 35, 6, 7, 8, 9, 15, 16, 17, 53,0]
    elif dataset in ['ames_50_1_train1_pos', 'ames_50_1_train1_neg', 'ames_50_2_train1_pos', 'ames_50_2_train1_neg', 'ames_50_3_train1_pos', 'ames_50_3_train1_neg', 'ames_50_4_train1_pos', 'ames_50_4_train1_neg', 'ames_50_5_train1_pos', 'ames_50_5_train1_neg', 'ames_50_6_train1_pos', 'ames_50_6_train1_neg', 'ames_50_7_train1_pos', 'ames_50_7_train1_neg', 'ames_50_8_train1_pos', 'ames_50_8_train1_neg']:
         atomic_num_list=[1, 35, 6, 7, 8, 9, 15, 16, 17, 53,0]
         ...
         atomic_num_list=[1, 6, 7, 8, 9, 11, 15, 16, 17, 14, 80, 28, 29, 34, 35, 53,0]
